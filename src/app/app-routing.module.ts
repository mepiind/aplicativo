...
const routes: Routes = [
  ...
  { path: 'catalogo', loadChildren: './catalogos/catalogo/catalogo.module#CatalogoPageModule' },
  { path: 'lista-setor', loadChildren: './lista-setor/lista-setor.module#ListaSetorPageModule' },
  { path: 'lista-databook-ano', loadChildren: './lista-databook/lista-databook-ano/lista-databook-ano.module#ListaDatabookAnoPageModule' },
